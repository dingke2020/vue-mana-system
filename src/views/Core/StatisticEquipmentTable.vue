<template>
  <div>
    <!--表格栏-->
    <el-table :data="data.data" :highlight-current-row="highlightCurrentRow" v-loading="loading" :border="border" :stripe="stripe" :max-height="maxHeight" :height="height" :size="size" style="width:100%;" :header-cell-style="{'background-color':'#E8ECEB','color':'#424242'}">
