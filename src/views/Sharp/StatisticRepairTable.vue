<template>
  <div>
    <!--表格栏-->
    <el-table class="repair" :data="data.data" :highlight-current-row="highlightCurrentRow" v-loading="loading" :border="border" :stripe="stripe" :max-height="maxHeight" :height="height" :size="size" style="width:100%;" :row-class-name="rowstatus" :header-cell-style="{'background-color':'#E8ECEB','color':'#424242'}" :row-style="{'height':'60px'}">
